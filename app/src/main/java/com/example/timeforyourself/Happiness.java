...
public class Happiness extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    private void showAlert() {
        final AlertDialog.Builder myBuilder = new AlertDialog.Builder(Happiness.this,R.style.ThemeOverlay_AppCompat_Dialog_Alert);
        ...
        ArrayAdapter<String> adapter = new ArrayAdapter<>(Happiness.this, android.R.layout.simple_spinner_item, getResources().getStringArray(R.array.hours));
        ArrayAdapter<String> adapter1 = new ArrayAdapter<>(Happiness.this, android.R.layout.simple_spinner_item, getResources().getStringArray(R.array.minutes));
