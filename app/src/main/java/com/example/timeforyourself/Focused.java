...
public class Focused extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    private void showAlert() {
        final AlertDialog.Builder myBuilder = new AlertDialog.Builder(Focused.this,R.style.ThemeOverlay_AppCompat_Dialog_Alert);
        ...
        ArrayAdapter<String> adapter = new ArrayAdapter<>(Focused.this, android.R.layout.simple_spinner_item, getResources().getStringArray(R.array.hours));
        ArrayAdapter<String> adapter1 = new ArrayAdapter<>(Focused.this, android.R.layout.simple_spinner_item, getResources().getStringArray(R.array.minutes));
