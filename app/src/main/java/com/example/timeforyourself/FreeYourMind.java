...
public class FreeYourMind extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_free_your);
    ...
    private void showAlert() {
        final AlertDialog.Builder myBuilder = new AlertDialog.Builder(FreeYourMind.this,R.style.ThemeOverlay_AppCompat_Dialog_Alert);
        ...
        ArrayAdapter<String> adapter = new ArrayAdapter<>(FreeYourMind.this, android.R.layout.simple_spinner_item, getResources().getStringArray(R.array.hours));
        ArrayAdapter<String> adapter1 = new ArrayAdapter<>(FreeYourMind.this, android.R.layout.simple_spinner_item, getResources().getStringArray(R.array.minutes));
